...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /root/ws_moveit/src/universal_robot/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /root/ws_moveit/devel/.private/ur_msgs)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /root/ws_moveit/install)
...
if(NOT "/root/ws_moveit/devel/.private/ur_msgs/include " STREQUAL " ")
  set(ur_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/root/ws_moveit/devel/.private/ur_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ws_moveit/src/universal_robot/ur_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ws_moveit/devel/.private/ur_msgs/lib;/root/ws_moveit/devel/lib;/opt/ros/noetic/lib)
