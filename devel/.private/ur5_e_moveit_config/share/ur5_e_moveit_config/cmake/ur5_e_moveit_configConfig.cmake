...
if("TRUE" STREQUAL "TRUE")
  set(ur5_e_moveit_config_SOURCE_PREFIX /root/ws_moveit/src/universal_robot/ur5_e_moveit_config)
  set(ur5_e_moveit_config_DEVEL_PREFIX /root/ws_moveit/devel/.private/ur5_e_moveit_config)
  ...
  set(ur5_e_moveit_config_INSTALL_PREFIX /root/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur5_e_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ws_moveit/src/universal_robot/ur5_e_moveit_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ws_moveit/devel/.private/ur5_e_moveit_config/lib;/root/ws_moveit/devel/lib;/opt/ros/noetic/lib)
