...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /root/ws_moveit/src/universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /root/ws_moveit/devel/.private/ur_gazebo)
  ...
  set(ur_gazebo_INSTALL_PREFIX /root/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ws_moveit/src/universal_robot/ur_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ws_moveit/devel/.private/ur_gazebo/lib;/root/ws_moveit/devel/lib;/opt/ros/noetic/lib)
